...
<body>
	...
	<div class="container">
		...
		<div class="button-container">
			<button class="update-button" onclick="BookController?action=update&bookID=">Update</button>
			<button class="delete-button" onclick="BookController?action=delete&bookID=">Delete</button>
		</div>
	</div>
</body>
</html>
