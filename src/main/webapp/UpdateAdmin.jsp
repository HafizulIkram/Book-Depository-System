    ...
    <div class="user-details">
        ...
        <div class="input-box">
	        ...
	        <div class="input-box">
	        	...
	        	<input type="text" name="adcontact" id="adcontact" value="${admin.ADCONTACT}" required><br>
	        </div>
	        
	        <div class="gender-details">
        	<input type="radio" name="adgender" value="male" <c:if test="${admin.ADGENDER == 'Male'}">selected</c:if> id="dot-1" required>
          	<input type="radio" name="adgender" value="female" <c:if test="${admin.ADGENDER == 'Female'}">selected</c:if> id="dot-2">
         	<label>Gender</label>
         	 <div class="category">
           		<label for="dot-1">
