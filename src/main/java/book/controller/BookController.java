...
public class BookController extends HttpServlet {
    ...
    private static String BOOKCART="studentCart.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      // TODO Auto-generated method stub
	  	...
	  	if (action.equalsIgnoreCase("searchstudent")) {
	  	    forward = LISTSD;
	  	    String btitle = request.getParameter("btitle");
	  	    List<Book> searchedBooks = BookDAO.getBookSearch(btitle);
	  	    request.setAttribute("books", searchedBooks);
	  	    
	  	    if (searchedBooks.isEmpty()) {
	  	        String script = "<script>displayNoBookFoundMessage();</script>";
